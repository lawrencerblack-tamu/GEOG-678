...
}`),e}function m(e,a){const o=a.camera.pixelRatio,n=e.magnifier.offset.x*o,s=e.magnifier.offset.y*o;r.screenPointObjectToArray(e.magnifier.position,v);const i=a.camera.screenToRender(v,x),u=Math.ceil(o*e.magnifier.size),l=a.camera.fullWidth,c=a.camera.fullHeight;return t.set(g,(i[0]+n)/l*2-1,(i[1]-s)/c*2-1,u/l*2,u/c*2)}const v=r.createScreenPointArray(),x=r.createRenderScreenPointArray(),g=a.create();e.MagnifierPassParameters=d,e.TextureResources=c,e.build=f,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"})}));
