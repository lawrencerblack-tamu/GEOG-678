...
*/
define(["exports","../views/3d/webgl-engine/core/shaderLibrary/util/View.glsl","../views/3d/webgl-engine/core/shaderModules/Float4PassUniform","../views/3d/webgl-engine/core/shaderModules/FloatPassUniform","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/lib/VertexAttribute"],(function(e,t,r,o,i,n,s){"use strict";function d(e){const d=new n.ShaderBuilder,{vertex:a,fragment:l}=d;t.addProjViewLocalOrigin(a,e),a.uniforms.add(new o.FloatPassUniform("width",(e=>e.width))),d.attributes.add(s.VertexAttribute.POSITION,"vec3"),d.attributes.add(s.VertexAttribute.NORMAL,"vec3"),d.attributes.add(s.VertexAttribute.UV0,"vec2"),d.attributes.add(s.VertexAttribute.LENGTH,"float"),d.varyings.add("vtc","vec2"),d.varyings.add("vlength","float"),d.varyings.add("vradius","float"),a.code.add(i.glsl`void main(void) {
...
gl_Position = proj * pos;
  ...
  `),d}const a=Object.freeze(Object.defineProperty({__proto__:null,build:d},Symbol.toStringTag,{value:"Module"}));e.MeasurementArrow=a,e.build=d}));
