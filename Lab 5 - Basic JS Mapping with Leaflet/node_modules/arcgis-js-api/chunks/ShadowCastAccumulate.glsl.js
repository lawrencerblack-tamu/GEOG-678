...
*/
define(["exports","../core/libs/gl-matrix-2/math/mat4","../core/libs/gl-matrix-2/factories/mat4f64","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/ReadDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ReadShadowMap.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/CameraSpace.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/RgbaFloatEncoding.glsl","../views/3d/webgl-engine/core/shaderModules/Float2PassUniform","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/Matrix4PassUniform","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform"],(function(e,a,r,i,s,t,o,d,l,n,c,h,p){"use strict";const u=255,w=1/u;function g(e){const r=new h.ShaderBuilder,u=r.fragment;return u.include(d.RgbaFloatEncoding),u.include(s.ReadLinearDepth),r.include(o.CameraSpace),r.include(i.ScreenSpacePass),r.include(t.ReadShadowMapPass,e),u.uniforms.add(new p.Texture2DPassUniform("shadowMap",((e,a)=>a.shadowMap.depthTexture)),new p.Texture2DPassUniform("depthMap",((e,a)=>a.linearDepth?.getTexture())),new c.Matrix4PassUniform("inverseViewMatrix",((e,r)=>a.invert(v,a.translate(v,r.camera.viewMatrix,r.camera.center)))),new l.Float2PassUniform("nearFar",((e,a)=>a.camera.nearFar))),u.constants.add("sampleValue","float",w),r.outputs.add("sampleCount","float"),u.code.add(n.glsl`void main(void) {
